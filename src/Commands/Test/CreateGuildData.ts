import { CommandInteraction, ApplicationCommandOptionType, ApplicationCommandType, Guild } from "discord.js";
...
export const CreateGuildData: Command = {
    ...
    description: "Creates GuildData for the current guild (FOR TESTING PURPOSES ONLY)",
